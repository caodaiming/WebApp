...
namespace WebApp.Web.Core.Extensions
{
    public static class SelectExtensions
    {
        ...
        public static SelectList ToSelectList(Type enumType, string selectItem)
        {
            ...
            foreach (var item in Enum.GetValues(enumType))
            {
                ...
                var listItem = new SelectListItem
                {
                    ...
                    Text = title,
                    Selected = selectItem == ((int)item).ToString()
                };
                items.Add(listItem);
            }
            return new SelectList(items, "Value", "Text", selectItem);
        }
